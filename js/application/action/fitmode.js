if(App.namespace) { App.namespace('Action.Fitmode', function(App) {

    /**
     * @namespace App.Action.Fitmode
     * @type {*}
     */
    var act = {};
    var toggler = false;
    ...
    /**
     * @namespace App.Action.Fitmode.toggle
     * @param toggle
     */
    act.toggle = function (toggle) {
    ...
    function zoomToFit() {
        ...
        applyConfig(scaleConfigs[4], project);
        gantt.render();
    }
